                    ...
                    @forelse($payments_elements as $item)
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="{{ getImage('public/assets/images/frontend/payments/' . @$item->data_values->image, '64x50') }}"
                                    alt="image">
                            </div><!-- brand-item end -->
                        </div>
                    @empty
            ...
            @guest
                <div class="col-lg-12 text-center mt-5">
                    <a href="{{ route('user.register') }}"
                        class="btn btn--base btn--capsule">@lang('Create an Account')</a>
                </div>
            @endguest
        </div><!-- row end -->
                ...
                <div class="subscribe-wrapper bg_img" data-background="assets/images/bg/bg-5.jpg">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 mt-lg-0 mt-4">
                            <form class="subscribe-form" action="{{ route('subscribe') }}"
                                method="post">
                                @csrf
