...
@include('partials.seo')
    ...
    <!-- lightcase css -->
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'css/vendor/lightcase.css')}}">
    <!-- slick slider css -->
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'css/vendor/slick.css')}}">
    <!-- jquery ui css -->
    <link rel="stylesheet" href="{{asset($activeTemplateTrue.'css/vendor/jquery-ui.min.css')}}">
    <!-- datepicker css -->
    ...
    <!-- header-section start  -->
        <header class="header">
            ...
            <div class="container">
                ...
                <a class="site-logo site-title" href="index.html"><img src="{{asset($activeTemplateTrue. 'images/logo.png')}}" alt="site-logo"><span class="logo-icon"><i class="flaticon-fire"></i></span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="nav-right">
                    <a href="contest.html" class="cmn-btn style--three btn--sm"><img src="{{asset($activeTemplateTrue. 'images/icon/btn/tag.png')}}" alt="icon" class="mr-2"> Buy Tickets</a>
                    </div>
                </div>
                </nav>
            </div>
        ...
        <!-- hero start -->
        <section class="hero">
        <div class="hero__shape"><img src="{{asset($activeTemplateTrue. 'images/elements/hero-shape.jpg.png')}}" alt="image"></div>
        <div class="hero__element"><img src="{{asset($activeTemplateTrue. 'images/elements/hero-building.png')}}" alt="image"></div>
        <div class="hero__car wow bounceIn" data-wow-duration="0.5s" data-wow-delay="1s">
            <img src="{{asset($activeTemplateTrue. 'images/elements/car-shadow.png')}}" alt="image" class="car-shadow">
            <img src="{{asset($activeTemplateTrue. 'images/elements/car-ray.png')}}" alt="image" class="car-ray">
            <img src="{{asset($activeTemplateTrue. 'images/elements/car-light.png')}}" alt="image" class="car-light">
            <img src="{{asset($activeTemplateTrue. 'images/elements/hero-car.png')}}" alt="image" class="hero-car">
            <img src="{{asset($activeTemplateTrue. 'images/elements/car-star.png')}}" alt="image" class="car-star">
        </div>
        <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <img src="{{asset($activeTemplateTrue. 'images/elements/car-main.png')}}" alt="">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="play-elements wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.7s">
            <img src="{{asset($activeTemplateTrue. 'images/elements/play-el.png')}}" alt="image">
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="play-card bg_img" data-background="{{asset($activeTemplateTrue. 'images/elements/card-bg-1.jpg')}}">
                <div class="play-card__icon">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/play/1.png')}}" alt="image-icon">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="play-card bg_img" data-background="{{asset($activeTemplateTrue. 'images/elements/card-bg-2.jpg')}}">
                <div class="play-card__icon">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/play/2.png')}}" alt="image-icon">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="play-card bg_img" data-background="{{asset($activeTemplateTrue. 'images/elements/card-bg-3.jpg')}}">
                <div class="play-card__icon">
                    <img src="{{asset($activeTemplateTrue. 'images/icon/play/3.png')}}" alt="image-icon">
        ...
        <div class="bg-el"><img src="{{asset($activeTemplateTrue. '/images/elements/contest-bg.png')}}" alt="image"></div>
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <li class="nav-item" role="presentation">
                    <a class="cmn-btn d-flex align-items-center active" id="car-tab" data-toggle="tab" href="#car" role="tab" aria-controls="car" aria-selected="true"><span class="mr-3"><img src="{{asset($activeTemplateTrue. '/images/icon/btn/car.png')}}" alt="icon"></span> Dream Car</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="cmn-btn style--two d-flex align-items-center" id="lifestyle-tab" data-toggle="tab" href="#lifestyle" role="tab" aria-controls="lifestyle" aria-selected="false"><span class="mr-3"><img src="{{asset($activeTemplateTrue. '/images/icon/btn/box.png')}}" alt="icon"></span>All lifestyle</a>
                </li>
                </ul>
                ...
                <div class="tab-pane fade show active" id="car" role="tabpanel" aria-labelledby="car-tab">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/1.png')}}" alt="image">
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <a href="contest-details-one.html" class="item-link"></a>
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/2.png')}}" alt="image">
                            <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                            <div class="contest-num">
                            <span>contest no:</span>
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <a href="contest-details-one.html" class="item-link"></a>
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/3.png')}}" alt="image">
                            <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                            <div class="contest-num">
                            <span>contest no:</span>
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <a href="contest-details-one.html" class="item-link"></a>
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/4.png')}}" alt="image">
                            <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                            <div class="contest-num">
                            <span>contest no:</span>
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <a href="contest-details-one.html" class="item-link"></a>
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/5.png')}}" alt="image">
                            <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                            <div class="contest-num">
                            <span>contest no:</span>
                    ...
                    <div class="col-xl-4 col-md-6 mb-30">
                        ...
                        <a href="contest-details-one.html" class="item-link"></a>
                        <div class="contest-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/contest/6.png')}}" alt="image">
                            <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                            <div class="contest-num">
                            <span>contest no:</span>
        ...
        <section class="position-relative pt-120 pb-120">
        <div class="bg-el"><img src="{{asset($activeTemplateTrue. '/images/bg/winner.jpg')}}" alt="image"></div>
        <div class="container">
            <div class="row justify-content-center">
            <div class="col-lg-8 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <div class="section-header text-center">
            ...
            <div class="col-lg-12">
                ...
                <div class="left">
                    <div class="winner-prize-thumb wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.5s"><img src="{{asset($activeTemplateTrue. '/images/elements/car.png')}}" alt="image"></div>
                </div>
                <div class="right">
                    <div class="winner-slider">
                    <div class="winner-slide-item">
                        <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/w-1.png')}}" alt="image"></div>
                        <div class="winner-content bg_img" data-background="{{asset($activeTemplateTrue. '/images/elements/winner-content-bg.jpg')}}">
        ...
        <div class="el-1"><img src="{{asset($activeTemplateTrue.'/images/elements/w-el-1.png')}}" alt="image"></div>
        <div class="el-2"><img src="{{asset($activeTemplateTrue.'/images/elements/w-el-2.png')}}" alt="image"></div>
        <div class="el-3"><img src="{{asset($activeTemplateTrue.'/images/elements/w-el-3.png')}}" alt="image"></div>
        <div class="container">
            <div class="row justify-content-center">
            <div class="col-lg-8 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <div class="section-header text-center">
            ...
            <div class="col-lg-12">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <div class="icon-thumb"><img src="{{asset($activeTemplateTrue. '/images/icon/winner-tab/1.png')}}" alt="image"></div>
                    <span>Dream Car</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="bike-tab" data-toggle="tab" href="#bike" role="tab" aria-controls="bike" aria-selected="false">
                    <div class="icon-thumb"><img src="{{asset($activeTemplateTrue. '/images/icon/winner-tab/2.png')}}" alt="image"></div>
                    <span>bike</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="watch-tab" data-toggle="tab" href="#watch" role="tab" aria-controls="watch" aria-selected="false">
                    <div class="icon-thumb"><img src="{{asset($activeTemplateTrue. '/images/icon/winner-tab/3.png')}}" alt="image"></div>
                    <span>watch</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="laptop-tab" data-toggle="tab" href="#laptop" role="tab" aria-controls="laptop" aria-selected="false">
                    <div class="icon-thumb"><img src="{{asset($activeTemplateTrue. '/images/icon/winner-tab/4.png')}}" alt="image"></div>
                    <span>laptop</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="money-tab" data-toggle="tab" href="#money" role="tab" aria-controls="money" aria-selected="false">
                    <div class="icon-thumb"><img src="{{asset($activeTemplateTrue. '/images/icon/winner-tab/5.png')}}" alt="image"></div>
                    <span>Money</span>
                    </a>
                </li>
                </ul>
                ...
                <div class="tab-pane fade show active" id="dream" role="tabpanel" aria-labelledby="dream-tab">
                    ...
                    <div class="col-lg-8 mb-30">
                        ...
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/6.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/1.png')}}" alt="image"></div>
                        ...
                        <div class="winner-card mb-30">
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/4.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/2.png')}}" alt="image"></div>
                            <div class="content-top">
                            <div class="left">
                                <h5>The Breeze Zodiac IX</h5>
                            </div>
                        ...
                        <div class="winner-card mb-30">
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/3.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/3.png')}}" alt="image"></div>
                            <div class="content-top">
                            <div class="left">
                                <h5>The Breeze Zodiac IX</h5>
                            </div>
                        ...
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/4.png')}}" alt="image"></div>
                            <div class="content-top">
                            <div class="left">
                                <h5>The Breeze Zodiac IX</h5>
                            </div>
                        ...
                        <div class="winner-card mb-30">
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/5.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/5.png')}}" alt="image"></div>
                            <div class="content-top">
                            <div class="left">
                                <h5>The Breeze Zodiac IX</h5>
                            </div>
                        ...
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/6.png')}}" alt="image"></div>
                            <div class="content-top">
                            <div class="left">
                                <h5>The Breeze Zodiac IX</h5>
                            </div>
                ...
                <div class="tab-pane fade" id="watch" role="tabpanel" aria-labelledby="watch-tab">
                    ...
                    <div class="col-lg-8 mb-30">
                        ...
                        <div class="winner-card mb-30">
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/2.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/2.png')}}" alt="image"></div>
                            <div class="content-top">
                ...
                <div class="tab-pane fade" id="laptop" role="tabpanel" aria-labelledby="laptop-tab">
                    ...
                    <div class="col-lg-8 mb-30">
                        <div class="winner-card mb-30">
                        <div class="winner-card__thumb">
                            <img src="{{asset($activeTemplateTrue. '/images/win-car/1.png')}}" alt="image">
                        </div>
                        <div class="winner-card__content">
                            <div class="winner-thumb"><img src="{{asset($activeTemplateTrue. '/images/winner/1.png')}}" alt="image"></div>
                            <div class="content-top">
        ...
        <div class="map-el"><img src="{{asset($activeTemplateTrue. '/images/elements/map.png')}}" alt="image"></div>
        <div class="obj-1"><img src="{{asset($activeTemplateTrue. '/images/elements/overview-obj-1.png')}}" alt="image"></div>
        <div class="obj-2"><img src="{{asset($activeTemplateTrue. '/images/elements/overview-obj-2.png')}}" alt="image"></div>
        <div class="obj-3"><img src="{{asset($activeTemplateTrue. '/images/elements/overview-obj-3.png')}}" alt="image"></div>
        <div class="obj-4"><img src="{{asset($activeTemplateTrue. '/images/elements/overview-obj-4.png')}}" alt="image"></div>
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-sm-6 mb-30 wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.3s">
                ...
                <div class="overview-card__icon">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/overview/1.png')}}" alt="">
                </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-30 wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <div class="overview-card hover--effect-1">
                <div class="overview-card__icon">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/overview/2.png')}}" alt="">
                </div>
                <div class="overview-card__content">
            ...
            <div class="col-lg-4 col-sm-6 mb-30 wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.7s">
                <div class="overview-card hover--effect-1">
                <div class="overview-card__icon">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/overview/3.png')}}" alt="">
                </div>
                <div class="overview-card__content">
            ...
            <div class="col-lg-6 order-lg-1 order-2">
                ...
                <div class="col-lg-6 mb-30">
                    ...
                    <div class="col-lg-12 col-md-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        ...
                        <div class="feature-card__icon">
                            <img src="{{asset($activeTemplateTrue. '/images/icon/feature/1.png')}}" alt="image">
                        </div>
                    ...
                    <div class="col-lg-12 col-md-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                        <div class="feature-card hover--effect-1">
                        <div class="feature-card__icon">
                            <img src="{{asset($activeTemplateTrue. '/images/icon/feature/3.png')}}" alt="image">
                        </div>
                        <div class="feature-card__content">
                ...
                <div class="col-lg-6 mb-30 mt-lg-5">
                    ...
                    <div class="col-lg-12 col-md-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.3s">
                        <div class="feature-card hover--effect-1">
                        <div class="feature-card__icon">
                            <img src="{{asset($activeTemplateTrue. '/images/icon/feature/2.png')}}" alt="image">
                        </div>
                        <div class="feature-card__content">
                    ...
                    <div class="col-lg-12 col-md-6 mb-30 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                        <div class="feature-card hover--effect-1">
                        <div class="feature-card__icon">
                            <img src="{{asset($activeTemplateTrue. '/images/icon/feature/4.png')}}" alt="image">
                        </div>
                        <div class="feature-card__content">
        ...
        <div class="bg-shape">
            <div class="round-shape d-sm-block d-none"><img src="{{asset($activeTemplateTrue. '/images/elements/round-shape.png')}}" alt="image"></div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="testimonial-area bg_img" data-background="{{asset($activeTemplateTrue. '/images/elements/testimonial-single.jpg')}}">
                <div class="testimonial-slider">
                    <div class="testimonial-single">
                    <div class="testimonial-single__thumb">
                        <img src="{{asset($activeTemplateTrue. '/images/winner/2.png')}}" alt="image">
                    </div>
                    ...
                    <div class="testimonial-single">
                    <div class="testimonial-single__thumb">
                        <img src="{{asset($activeTemplateTrue. '/images/winner/1.png')}}" alt="image">
                    </div>
                    <div class="testimonial-single__content">
                        <h4 class="client-name">Dave Ford</h4>
                        <p>“Unbelievable this is a dream come true,no way would I ever think I would own a car like this” </p>
        ...
        <div class="container">
            ...
            <div class="col-lg-6 mb-30 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.3s">
                ...
                <div class="support-card__thumb">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/support/1.png')}}" alt="image">
                </div>
            ...
            <div class="col-lg-6 mb-30 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <div class="support-card">
                <div class="support-card__thumb">
                    <img src="{{asset($activeTemplateTrue. '/images/icon/support/2.png')}}" alt="image">
                </div>
                <div class="support-card__content">
        ...
        <footer class="footer-section">
            <div class="bg-shape--top"><img src="{{asset($activeTemplateTrue. '/images/elements/round-shape-2.png')}}" alt="image"></div>
            <div class="container">
            <div class="row">
            ...
            <div class="row pb-5 align-items-center">
                <div class="col-lg-4">
                <ul class="app-btn">
                    <li><a href="#0"><img src="{{asset($activeTemplateTrue. '/images/icon/store-btn/1.png')}}" alt="image"></a></li>
                    <li><a href="#0"><img src="{{asset($activeTemplateTrue. '/images/icon/store-btn/2.png')}}" alt="image"></a></li>
                </ul>
                </div>
                <div class="col-lg-8">
            ...
            <div class="row py-5 align-items-center">
                <div class="col-lg-6">
                <p class="copy-right-text text-lg-left text-center mb-lg-0 mb-3">Copyright © 2020.All Rights Reserved By <a href="index.html">Rifa</a></p>
                </div>
                <div class="col-lg-6">
...
<script src="{{asset($activeTemplateTrue.'js/vendor/MorphSVGPlugin.min.js')}}"></script>
<script src="{{asset($activeTemplateTrue.'js/preloader.js')}}"></script>
<!-- contact js -->
