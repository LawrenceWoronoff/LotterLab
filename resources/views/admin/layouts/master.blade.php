...
<head>
    ...
    <!-- bootstrap 4  -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/bootstrap.min.css') }}">
    <!-- bootstrap toggle css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/bootstrap-toggle.min.css') }}">
    <!-- fontawesome 5  -->
    ...
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/nice-select.css') }}">
    <!-- code preview css -->
    <link rel="stylesheet" href="{{ asset('public/assets/admin/css/vendor/prism.css') }}">
    <!-- select 2 css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/select2.min.css') }}">
    <!-- jvectormap css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/jquery-jvectormap-2.0.5.css') }}">
    <!-- datepicker css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/datepicker.min.css') }}">
    <!-- timepicky for time picker css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/jquery-timepicky.css') }}">
    <!-- bootstrap-clockpicker css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/bootstrap-clockpicker.min.css') }}">
    <!-- bootstrap-pincode css -->
    <link rel="stylesheet"
        href="{{ asset('public/assets/admin/css/vendor/bootstrap-pincode-input.css') }}">
    <!-- dashdoard main css -->
